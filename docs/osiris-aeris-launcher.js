...
(function () {
  ...
  function installLauncher() {
    ...
    for (const eventName of ['click', 'touchend', 'pointerup']) {
      button.addEventListener(eventName, openAeris, { capture: true, passive: false });
    }
  }
  ...
  function install() {
    ...
    window.__osirisAerisLauncher = { version: VERSION, open: openAeris, path: getAerisPath };
  }
